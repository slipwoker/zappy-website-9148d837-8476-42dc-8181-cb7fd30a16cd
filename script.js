document.addEventListener('DOMContentLoaded', function () {
  ...
  function handleFormSuccess(form) {
    ...
    successMsg.textContent = 'Your message has been sent successfully. We will be in touch soon.';
  ...
  if ('IntersectionObserver' in window) {
    const animationObserver = new IntersectionObserver(onIntersection, animationObserverOptions);

    document.querySelectorAll(OBSERVE_SELECTOR).forEach(function (el) {
    ...
    const dynamicObserver = new MutationObserver(function (mutations) {
      mutations.forEach(function (mutation) {
        mutation.addedNodes.forEach(function (node) {
          ...
          if (
            node.classList.contains(OBSERVE_CLASS) ||
          ...
          node.querySelectorAll(OBSERVE_SELECTOR).forEach(function (child) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאור שרון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '9148d837-8476-42dc-8181-cb7fd30a16cd',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '9148d837-8476-42dc-8181-cb7fd30a16cd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9148d837-8476-42dc-8181-cb7fd30a16cd';
